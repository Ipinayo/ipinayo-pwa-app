...
async function main() {
    ...
    massSelections.push(
        // Advent Mass - Public
        await prisma.massSelection.create({
            data: {
                ...
                parts: {
                    create: massPartsTemplates.traditional.map(part => ({
                        ...part,
    ...
    massSelections.push(
        ...
        await prisma.massSelection.create({
            data: {
                ...
                parts: {
                    create: massPartsTemplates.contemporary
                }
            }
        }),
    ...
    massSelections.push(
        ...
        await prisma.massSelection.create({
            data: {
                ...
                parts: {
                    create: massPartsTemplates.bilingual
                }
            }
        }),
    ...
    massSelections.push(
        ...
        await prisma.massSelection.create({
            data: {
                ...
                parts: {
                    create: massPartsTemplates.simple
                }
            }
        }),
    ...
    console.log('Created Mass Selections with parts...')
    ...
    console.log(`✉️  Verification Tokens: ${totalVerificationTokens}`)
