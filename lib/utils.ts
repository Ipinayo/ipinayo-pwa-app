...
const ACTIVITY_ENTITY: EventText = {
  ...
  "selection.commented": (m) => m.title,
  "draft.commented": (m) => m.title,
  "selection.comment_mention": (m) => m.title,
  "draft.comment_mention": (m) => m.title,
...
const ACTIVITY_EVENT: {
  ...
  "selection.commented": (admin) => admin ? "Selection comment" : "New comment",
  "draft.commented": (admin) => admin ? "Draft comment" : "New comment",
  "selection.comment_mention": (admin) => admin ? "Selection mention" : "You were mentioned",
  "draft.comment_mention": (admin) => admin ? "Draft mention" : "You were mentioned",
