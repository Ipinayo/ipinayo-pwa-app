...
export function CreateMassSelection() {
  ...
  const [selectedTemplate, setSelectedTemplate] =
    useState<LiturgicalTemplate | null>(null);
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Start by providing basic details about your Mass selection
              </p>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the basic information for your Mass selection
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select a liturgical template to get started with appropriate
                  Mass parts
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        {step === 2 && selectedTemplate && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Configure the musical selections for each part of the Mass
              </p>
            </div>
                ...
                {parts.map((part, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {templatePart?.suggestions &&
                        templatePart.suggestions.length > 0 && (
                          <div className="space-y-2">
                            <Label className="text-sm font-medium">
                              Suggestions:
                            </Label>
                            <div className="flex flex-wrap gap-2">
                              {templatePart.suggestions.map(
