...
export function ViewMassSelection({ id }: ViewMassSelectionProps) {
  ...
  const isOwner =
    selection && session?.user?.email === selection.createdBy.email;
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The mass selection you're looking for doesn't exist or is not
            accessible.
          </p>
          <Button asChild>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Musical selections for each part of the Mass
              </CardDescription>
            </CardHeader>
            <CardContent>
