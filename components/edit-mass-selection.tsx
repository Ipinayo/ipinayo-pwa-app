...
export function EditMassSelection({ id }: EditMassSelectionProps) {
  ...
  const handlePartChange = (index: number, field: keyof MassPart, value: string) => {
    ...
    const updatedParts = selection.parts.map((part, i) => (i === index ? { ...part, [field]: value } : part))
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The mass selection you're looking for doesn't exist or you don't have permission to edit it.
          </p>
          <Button asChild>
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-display text-primary">Edit Mass Selection</h1>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="space-y-8">
          <div className="text-center">
            <h2 className="text-3xl font-display text-foreground mb-2">Edit: {selection.title}</h2>
            <p className="text-muted-foreground">Make changes to your Mass selection</p>
          </div>

          <Card>
            <CardHeader>
              <CardTitle>Mass Details</CardTitle>
              <CardDescription>Update the basic information for your Mass selection</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelection({ ...selection, liturgicalYear: value })}
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) => setSelection({ ...selection, isPublic: checked })}
                    />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setSelection({ ...selection, themes: e.target.value })}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setSelection({ ...selection, pastoralFocus: e.target.value })}
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update the musical selections for each part of the Mass</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
